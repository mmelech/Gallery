 ...
 */
final class Version20230630095612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__photos AS SELECT id, gallery_id, date, title, content, filename FROM photos');
        ...
        $this->addSql('INSERT INTO photos (id, gallery_id, date, title, content, filename) SELECT id, gallery_id, date, title, content, filename FROM __temp__photos');
