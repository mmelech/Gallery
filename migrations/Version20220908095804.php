 ...
 */
final class Version20220908095804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO photos (id, gallery_id, date, title, content) SELECT id, category_id, date, title, content FROM __temp__photos');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO photos (id, category_id, date, title, content) SELECT id, gallery_id, date, title, content FROM __temp__photos');
        $this->addSql('DROP TABLE __temp__photos');
