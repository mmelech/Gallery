 ...
 */
final class Version20220908094941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , title VARCHAR(120) NOT NULL, content CLOB NOT NULL, CONSTRAINT FK_876E0D912469DE2 FOREIGN KEY (category_id) REFERENCES galleries (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(45) NOT NULL COLLATE BINARY)');
