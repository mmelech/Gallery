 ...
 */
final class Version20220908110845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_1677722FA76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__avatar AS SELECT id, user_id, file_name FROM avatar');
        $this->addSql('DROP TABLE avatar');
        $this->addSql('CREATE TABLE avatar (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, file_name VARCHAR(191) NOT NULL, CONSTRAINT FK_1677722FA76ED395 FOREIGN KEY (user_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO avatar (id, user_id, file_name) SELECT id, user_id, file_name FROM __temp__avatar');
        $this->addSql('DROP TABLE __temp__avatar');
        ...
        , title VARCHAR(120) NOT NULL, content CLOB NOT NULL, CONSTRAINT FK_876E0D94E7AF8F FOREIGN KEY (gallery_id) REFERENCES galleries (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__avatar AS SELECT id, user_id, file_name FROM avatar');
        $this->addSql('DROP TABLE avatar');
        $this->addSql('CREATE TABLE avatar (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, file_name VARCHAR(191) NOT NULL)');
        $this->addSql('INSERT INTO avatar (id, user_id, file_name) SELECT id, user_id, file_name FROM __temp__avatar');
        $this->addSql('DROP TABLE __temp__avatar');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1677722FA76ED395 ON avatar (user_id)');
        $this->addSql('DROP INDEX IDX_5F9E962A7E9E4C8C');
