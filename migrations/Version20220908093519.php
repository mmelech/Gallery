 ...
 */
final class Version20220908093519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO comments (id, photo_id, author_id, content, date) SELECT id, post_id, author_id, content, date FROM __temp__comments');
        ...
        $this->addSql('DROP INDEX IDX_876E0D912469DE2');
        $this->addSql('CREATE TEMPORARY TABLE __temp__photos AS SELECT id, category_id, date, title, content FROM photos');
        ...
        , title VARCHAR(120) NOT NULL, content CLOB NOT NULL, CONSTRAINT FK_876E0D912469DE2 FOREIGN KEY (category_id) REFERENCES categories (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO photos (id, category_id, date, title, content) SELECT id, category_id, date, title, content FROM __temp__photos');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO comments (id, post_id, author_id, content, date) SELECT id, photo_id, author_id, content, date FROM __temp__comments');
        $this->addSql('DROP TABLE __temp__comments');
        $this->addSql('CREATE INDEX IDX_5F9E962AF675F31B ON comments (author_id)');
